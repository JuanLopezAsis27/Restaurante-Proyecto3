                ...
                <div>
                        ...
                        <div className="grid grid-cols-2 md:gap-28 lg:gap-56 px-4 py-6 lg:py-8 md:grid-cols-4">
                            <div>
                                ...
                                <ul className="text-gray-200 dark:text-gray-400 font-medium">
                                    <li className="mb-4">
                                        <Link to='/errorScreen' className=" hover:underline">Sobre Nosotros</Link>
                                    </li>
                                    <li className="mb-4">
                                        <Link to='/errorScreen' className="hover:underline">Contacto</Link>
                                    </li>
                                    <li className="mb-4">
                                        <Link to='/errorScreen' className="hover:underline">Galeria de Imagenes</Link>
                                    </li>
                                </ul>
                            </div>
                            <div>
                                ...
                                <ul className="text-gray-200 dark:text-gray-400 font-medium">
                                    <li className="mb-4">
                                        <Link to='/errorScreen' className="hover:underline">Discord</Link>
                                    </li>
                                    <li className="mb-4">
                                        <Link to='/errorScreen' className="hover:underline">Twitter</Link>
                                    </li>
                                    <li className="mb-4">
                                        <Link to='/errorScreen' className="hover:underline">Facebook</Link>
                                    </li>
                                </ul>
                            </div>
                            <div>
                                ...
                                <ul className="text-gray-200 dark:text-gray-400 font-medium">
                                    <li className="mb-4">
                                        <Link to='/errorScreen' className="hover:underline">Politica de privacidad</Link>
                                    </li>
                                    <li className="mb-4">
                                        <Link to='/errorScreen' className="hover:underline">Licencias</Link>
                                    </li>
                                    <li className="mb-4">
                                        <Link to='/errorScreen' className="hover:underline">Terminos &amp; Condiciones</Link>
                                    </li>
                                </ul>
                            </div>
                            <div>
                                ...
                                <ul className="text-gray-200 dark:text-gray-400 font-medium">
                                    <li className="mb-4">
                                        <Link to='/errorScreen' className="hover:underline">iOS</Link>
                                    </li>
                                    <li className="mb-4">
                                        <Link to='/errorScreen' className="hover:underline">Android</Link>
                                    </li>
                                    <li className="mb-4">
                                        <Link to='/errorScreen' className="hover:underline">Windows</Link>
                                    </li>                                    
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="md:px-16 lg:px-28 py-6 text-center bg-stone-950 dark:bg-gray-700 md:flex md:items-center md:justify-between ">
                        ...
                        <div className="flex mt-4  justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
                            <Link to='/errorScreen' className="text-gray-100 hover:text-orange-700 dark:hover:text-white">
