...
const Navbar = () => {
    ...
    return (
        <nav className='bg-zinc-700 mb-3 flex justify-between py-2 lg:px-10 px-4 w-full'>
                                        ...
                                        <div className='flex flex-col '>
                                            <div>
                                                <svg width="50px" height="50px" className='triangulo flex top-17 left-7'>
                                                    <polygon fill="rgb(194 65 12)" stroke="rgb(194 65 12)" strokeWidth="4px" points="5 13.75, 11.25 1.75, 17.5 13.75" />
                                                </svg>
                                            </div>
                                            <div ref={menuRef} className='bg-orange-700 p-2 w-44 shadow-lg rounded-md absolute -left-12 top-24 dropdown'>
